...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.intivoto.flutter_geofence.FlutterGeofencePlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin flutter_geofence, com.intivoto.flutter_geofence.FlutterGeofencePlugin", e);
    }
    try {
